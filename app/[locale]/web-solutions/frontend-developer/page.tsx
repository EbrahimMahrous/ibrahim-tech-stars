    ...
    const loadContent = async () => {
      try {
        const module = await import(
          `@/content/${locale}/web-solutions/frontend-developer`
        );
        setContent(module.frontendDeveloperContent);
      } catch (error) {
        console.error("Error loading content:", error);
        const fallback = await import(
          `@/content/ar/web-solutions/frontend-developer`
        );
        setContent(fallback.frontendDeveloperContent);
      }
    };
