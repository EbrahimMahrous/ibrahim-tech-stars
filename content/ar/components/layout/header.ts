export const headerContent = {
  navItems: {
    ...
    webSolutions: {
      ...
      items: {
        frontendDeveloper: {
          label: "مطور ويب احترافي",
          title: "تطوير واجهات مواقع الويب",
          keywords: ["مطور ويب", "تطوير مواقع", "برمجة واجهات"],
        },
        wordpress: {
          label: "تطوير ووردبريس",
          title: "تصميم وتطوير مواقع ووردبريس",
          keywords: ["وردبريس", "مواقع ووردبريس", "قوالب ووردبريس"],
        },
        shopify: {
          label: "متاجر شوبيفاي",
          title: "تصميم متاجر شوبيفاي الإلكترونية",
          keywords: ["متجر الكتروني", "شوبيفاي", "تجارة الكترونية"],
        },
        zid: {
          label: "منصة زد للتجارة",
          title: "تطوير متاجر على منصة زد",
          keywords: ["متجر زد", "منصة زد", "تجارة الكترونية سعودية"],
        },
        salla: {
          label: "متاجر سلة",
          title: "تطوير متاجر على منصة سلة",
          keywords: ["متجر سلة", "منصة سلة", "تجارة الكترونية"],
        },
      },
    },
    salesEngineer: {
    ...
    customerServices: {
      label: "خدمة عملاء",
      title: "خدمة ودعم العملاء",
      ariaLabel: "خدمات دعم العملاء",
    ...
    extras: {
      ...
      items: {
        english: {
          label: "دروس الإنجليزية",
          title: "تعلم اللغة الإنجليزية",
          keywords: ["دروس انجليزية", "تعلم اللغة", "مهارات لغوية"],
        },
        certificates: {
          label: "شهادات معتمدة",
          title: "الشهادات المهنية المعتمدة",
          keywords: ["شهادات مهنية", "اعتمادات", "تدريب معتمد"],
        },
        awards: {
          label: "جوائز وتكريمات",
          title: "الجوائز والإنجازات المهنية",
          keywords: ["جوائز", "تكريمات", "انجازات مهنية"],
        },
        proudBeginnings: {
          label: "البدايات والخبرات",
          title: "رحلة العمل والخبرات المهنية",
          keywords: ["البدايات", "خبرات عمل", "رحلة مهنية"],
        },
      },
    },
  },
  ...
  buttons: {
    consultation: {
      ...
      title: "استشارة مجانية في تطوير الويب",
    ...
    darkMode: {
      ...
      switchTheme: "تبديل وضع الليل والنهار",
      toggleMobile: "تبديل وضع التصميم",
    },
    mobileMenu: {
